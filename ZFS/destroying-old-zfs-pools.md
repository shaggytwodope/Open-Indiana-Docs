# Removing old ZFS system pools/images


```bash

adrian@openindiana-tuts:~$ zfs list # lists your current zfs pools
...
adrian@openindiana-tuts:~$ # the share we want to get rid of is rpool/ROOT/openindiana
adrian@openindiana-tuts:~$ # since that is the image without updates on it
...
rpool/swap                 816M  24.9G   120M  -
adrian@openindiana-tuts:~$ # we have now removed the image!
